...
4. Crea/Referencia una nueva **branch** y nómbrala `feat/community/TU_USERNAME`: `git checkout -b feat/community/TU_USERNAME`;`´git checkout -b`feat/community/TU_USERNAME`;
    > Ejemplo: `git checkout -b feat/ `feat/community/TU_USERNAME`;community/rafaeldscordeiro`
5. Dentro de la carpeta [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community), crea un archivo en Markdown (extensión `.md`) y nómbralo con el mismo nombre de tu usuario en GitHub;
    > Ejemplo:´git checkout -b `rafaeldscordeiro.md` <br>
